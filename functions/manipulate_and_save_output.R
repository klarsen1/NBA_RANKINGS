manipulate_and_save_output <- function(clusters_and_players, scores, model_parts, model_details, root, back_test, save, overwrite_date=NA){
  ...
  if (back_test==0){
     ...
     select(DATE, home_team_name, road_team_name, selected_team, road_team_prob_win, home_team_prob_win, prob_selected_team_win, selected_team_win, actual_winner, current_season_data_used, future_game)
