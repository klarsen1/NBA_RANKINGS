...
As we all know, the 2017 NBA playoffs kicked off last weekend. But what you didn't know is that I've simulated the outcome by running the qualifying teams through playoff tree using the [Elastic NBA Ratings](https://github.com/klarsen1/NBA_RANKINGS).
...
Obviously, this is just a model, and many things can happen between now and the finals and the style of play is different in the playoffs. But, barring any serious injuries, I feel confident that the Golden State will take the title this year. I feel less confident, however, that Boston will indeed beat the Cavs in a playoff series, and I also doubt that San Antonio will beat Houston -- despite having the better record. 
