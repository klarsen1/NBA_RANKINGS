...
The 2017 NBA playoffs start ts weekend. So of course I had run the model through the [Elastic NBA Ratings](https://github.com/klarsen1/NBA_RANKINGS) to simulate the playoffs and pick a winner.

Some results from the model:
* First, a not-so-controversial. The Golden State Warriors won the title in every single simulation, barely losing any games along the way. 
* More interestingly, however, is that the model picks the Boston Celtics as Golden State's opponent in the finals. The model predicts that the Celtics will dispose the Cavs in five games
...
* The red bars show that circumstances -- e.g., traveling -- does not matter much for the playoffs.
