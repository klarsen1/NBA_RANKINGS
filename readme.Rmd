...
The team rankings produced by this model mainly agree with other prediction models (such as FiveThirtyEight) on the "tail teams" -- i.e., the teams that should be considered front runners and the teams that will win very few games this season. 
...
f1 <- 
  "https://raw.githubusercontent.com/klarsen1/NBA_RANKINGS/master/cleandata/FiveThirtyEight_2016-11-16.csv"
f2 <- 
  "https://raw.githubusercontent.com/klarsen1/NBA_RANKINGS/master/rankings/rankings_2016-11-16.csv"
...
For each group, the underlyiing predictors were multiplied by their respective coefficients and then aggregated to get the contributions to the predicted probabilities. The code below shows how to do that:
...
Game level predictions will be saved each Monday in this github repo: 
