...
| Archetype     | Team 1 Allocation | Team 2 Allocation  |  Difference | Coefficient | 
|:--------------|:------------------|:-------------------|:------------|:------------|
| Archetype 1   | 0.10              | 0.15               |  -0.05      | -2          |
| Archetype 2   | 0.05              | 0.05               |  0          | -1.5        |
| .             | .                 | .                  |  .          | .           |
| Arcyetype 25  | 0.1               | 0.05               |  0.04       | 2.5         |

#####Team 1:
X_1 =  % of minutes allocated to cluster 1, X_2 = % of minutes allocated to cluster 2, etc.
 
#####Team 2:
Z_1 =  % of minutes allocated to cluster 1, Z_2 = % of minutes allocated to cluster 2, etc.
