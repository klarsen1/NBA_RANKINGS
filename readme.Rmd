...
ranking <- 
bb_rankings <- read.csv("https://raw.githubusercontent.com/klarsen1/NBA_RANKINGS/master/rankings/rankings_2016-11-13.csv", header=TRUE, stringsAsFactors = FALSE) %>%
  mutate(rank_blackbox=min_rank(pred_win_rate))
knitr::kable(rankings)
```



t=read.csv("/Users/kimlarsen/Documents/Code/NBA_RANKINGS/rankings/rankings_2016-11-13.csv")
