...
# Summary -- What You Need to Know About This Model
...
Checking the game-level predictions. Note that the model is most accurate for the "tail teams" -- which is to be expected. The chart below shows the game-level accuracies after subtracting 0.5 which is the accuracy of a random draw.
